...
angular.module('gt-gamers-guild.d3', [])
...
angular.module('gt-gamers-guild.testing', [])
...
(function(module) {
try {
  module = angular.module('gt-gamers-guild.templates');
} catch (e) {
  module = angular.module('gt-gamers-guild.templates', []);
}
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('states/games/games-tmpl.html',
    '<div ui-view="form"></div><div class="container">Da Games<div class="gameTile" ng-repeat="game in games"><div ng-click="selectGame(game)"><p>{{game.Name}}</p><img src="{{game.Image}}" alt="{{game.Name}} image"></div></div></div>');
}]);
})();
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('states/games/upload-tmpl.html',
    '<p>Hi</p><div class="form-group"><form class="form-group" id="fileForm" method="post" action="/uploadFile" enctype="multipart/form-data"><h3>Upload a File</h3><label for="inputFile">File to Upload</label><input type="text" id="gameID" name="gameID" value="{{gameID.ID}}"><input class="form-control-file" type="file" id="inputFile" name="inputFile" aria-describedby="fileHelp"><button class="btn btn-priary" id="submitButton">Submit</button></form></div>');
}]);
})();
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('states/home/home-tmpl.html',
    '<div class="jumbotron"><h1 id="heroHeader">GT Gamer\'s Guild</h1><p>Georgia Tech\'s student organization for casual board games and tabletop games</p><div class="carousel slide" id="homeCarousel" data-ride="carousel"><ol class="carousel-indicators"><li class="active" data-target="#homeCarousel" data-slide-to="0"></li><li data-target="#homeCarousel" data-slide-to="1"></li><li data-target="#homeCarousel" data-slide-to="2"></li></ol><div class="carousel-inner"><div class="item active"><img src="media/bsg.jpg"></div><div class="item"><img src="media/whiteChapel.jpg"></div><div class="item"><img src="media/zombiecide.jpg"></div></div></div></div>');
}]);
})();
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('states/nav/nav-tmpl.html',
    '<nav class="navbar navbar-toggleable bg-faded container" ng-controller="NavCtrl"><a class="navbar-brand" href="#">Navbar</a><div class="collapse navbar-collapse" id="navbarSupportedContent"><ul class="navbar-nav mr-auto nav"><li class="nav-item"><a class="nav-link" ng-click="go(\'layout.home\')">Home</a></li><li class="nav-item"><a class="nav-link" ng-click="go(\'layout.games\')">Games</a></li><li class="nav-item"><a class="nav-link">Request a Game</a></li><li class="nav-item"><a class="nav-link">About</a></li><li class="nav-item"><a class="nav-link">Blog</a></li></ul></div></nav>');
}]);
})();
